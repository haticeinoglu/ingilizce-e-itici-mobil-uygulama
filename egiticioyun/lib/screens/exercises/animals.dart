...
List<Item> animals= [
  Item(name: 'One', imagePath: 'assets/images/animals/one.jpg', audioPath: 'assets/sound/One.mp3'),
  Item(name: 'Two', imagePath: 'assets/images/animals/two.jpg', audioPath: 'assets/sound/Two.mp3'),
  // Diğer sayılar...
];
